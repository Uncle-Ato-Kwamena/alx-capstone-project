...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto p-4" style={{ backgroundColor: '#fffae6' }}> 
    <h1 className="text-4xl font-bold text-center my-8 text-orange-600">Infinite Recipe Finder</h1> 
    <img src= "src/assets/image.jpg" alt="Header Separator" className="my-4" /> 
